...
const filterOutOddsEx = (...arguments) => arguments.filter(num => num % 2 === 0);
...
const findMax = (...argument) => Math.max(...argument)
...
//     }
// ]
// const mergeObjects =[...mergeObject];
...
const doubleAndReturnArgs = (arr, ...argument) => [...arr, argument.map((num)=> num *2)]
...
const removeRandom = items => {
    let element = Math.floor(Math.random()*items)
    return [...items.slice(0,element),...items.slice(element + 1)]
}
